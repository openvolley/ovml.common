...
ovml_example_image <- function(choices = 1) {
    ...
    out[choices == 1] <- system.file("extdata/images/2019_03_01-KATS-BEDS-frame.jpg", package = "ovml.common")
    out[choices == 2] <- system.file("extdata/images/dog.jpg", package = "ovml.common")
    out
}

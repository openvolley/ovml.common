...
[![R build
status](https://github.com/openvolley/ovml.common/workflows/R-CMD-check/badge.svg)](https://github.com/openvolley/ovml.common/actions)
<!-- badges: end -->

This is a support package and not intended to be used directly.
